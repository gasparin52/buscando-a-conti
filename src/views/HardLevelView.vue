  ...
  <div class="container">
    <div class="start-content">
        ...
        <ModalContinuar
          ...
          descripcion="Dificultad: Difícil"
          animClass="anim-dificil"
...
import { hardScenes } from '../data/scenes.js';
...
const currentScene = computed(() => hardScenes[sceneIndex.value]);
...
function onSuccess() {
  if (sceneIndex.value < hardScenes.length - 1) {
    sceneIndex.value++;
  } else {
